            ...
            <div class="grid gap-5 lg:grid-cols-3 mt-20">
                ...
                <section class="py-16 px-6 col-span-2 space-y-10 flex flex-col justify-center divide-y divide-amber-500">
                    <article class="flex gap-4 items-start  px-5 pb-10">
                        <div
                            class="shrink-0 w-14 h-14 rounded-full border-2 border-purple-600 bg-purple-100 flex items-center justify-center">
                    ...
                    <article class="flex gap-4 items-start  px-5  pb-10">
                        <div
                            class="shrink-0 w-14 h-14 rounded-full border-2 border-orange-600 bg-orange-100 flex items-center justify-center">
                    ...
                    <article class="flex gap-4 items-start  px-5  pb-10">
                        <div
                            class="shrink-0 w-14 h-14 rounded-full border-2 border-pink-600 bg-pink-100 flex items-center justify-center">
                        ...
                        <div>
                            ...
                            <p class="text-lg">Agrega Gastos, Pregunta sobre tu presupuestos o Registra tus Tickets de
                                Compra</p>
                        </div>
                    </article>
