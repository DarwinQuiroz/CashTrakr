...
class SearchExpenses implements Tool
{
    ...
    {
        return 'Buscar gastos del presupuesto actual, puedes filtrar por nombre, gastos más baratos o costosos, buscar gastos por categoría o traer y mostrar todos los gastos.';
    }
    ...
    public function schema(JsonSchema $schema): array
    {
        return [
            ...
            'category' => $schema->string()->description('Categoría del gasto (ej: food, trasnport, hosuing, subscriptions, other)'),
        ];
    }
}
